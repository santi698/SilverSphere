...
public class Board implements Serializable{
	 ...
	 * @throws InvalidLevelException Cuando el nivel no respeta el formato estÃ¡ndar
	 */
	...
	private void parse(String[] s) throws InvalidLevelException {
		...
		if (f.getCount('@') != 1 || f.getCount('C') == 0 ||
			...
			throw new InvalidLevelException("Debe haber exactamente un personaje, un destino" +
					", al menos un cubo de hielo, y no mÃ¡s de un interruptor." +
	...
	/**
	 * Retorna la celda en la posiciÃ³n (x, y)
	 * @param x 
	 * @param y
	 * @return la celda en la posiciÃ³n (x, y)
	 */
