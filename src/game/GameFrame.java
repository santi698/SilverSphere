...
public class GameFrame extends JFrame {
	...
	protected void saveGame(File f) throws IOException {
		...
		if (f != null) {
			try {
				...
				JOptionPane.showMessageDialog(this, "El archivo estÃ¡ mal formado", 
	...
	/**
	 * mï¿½todo que retorna nuevamente al menï¿½ inicial.
	 */
			...
			if (boardPanel.isVisible()) {
				...
				if (direction != null) {
					...
					if (ret.equals(MoveRes.WATER_REACHED)) {
						JOptionPane.showMessageDialog(this, "Has perdido, el jugador cayÃ³ al agua");
						startGame();
					}
